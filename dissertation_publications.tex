...
The author made major contribution to defining optimization problem and to constructing the learning system.
The author also implemented the \sdp\ and the \greedy\ inference algorithm.
...
The new model incorporate the correlation of the output variables into the learning process by means of an output graph that connects multiple output variables.
As a results, the new model surpasses the previous single-label classification approach in terms of the prediction performance.
...
The proposed model extends \citepub{su10} by learning a majority voting ensemble of a set of structured output classifiers built from random output graphs.
