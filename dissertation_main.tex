...
To measure the goodness of the estimator, we define a loss function $\Lcal(y,f(\vx)):\Ycal\times\Ycal\rightarrow\RR^+$ between the true value $y$ and the predicted value $f(\vx)$.
...
\begin{align*}
	\Lcal_{hinge}(y,f(\vx)) = \maximize (0,1-y f(\vx)),
\end{align*}
