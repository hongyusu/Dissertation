...
The second outcome of the thesis is the new learning algorithms for structured output learning that are no longer constrained to the availability of the output graph.
