...
The inference problem (Definition~\ref{mmcrfinference}) is solved by loopy belief propagation (\lbp) on a general graph which is an instantiation of message-passing algorithm \citep{Wainwright08graphical}.
