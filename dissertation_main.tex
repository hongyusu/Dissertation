...
In particular, the algorithm loops through training examples and updates $\vw$ whenever the predicted label $\hat{\vy_i}$ is different from the true label $\vy_i$ defined by
\begin{align}
...
% mam
\amm\ performs the inference to find the max-marginals before combining the base classifiers into ensemble. 
...
The later measures the correlation of microlabel predictions in which higher correlation lead to better improvements.
