...
\begin{lemma}
	The inference problem (\ref{spin_np}) can be expressed equivalently with a set of activated vertices $V^H_{\p}$ and the marginal gain $F_m(v_i)$ on each vertex $v_i\in V^H_{\p}$
	\begin{align*}
