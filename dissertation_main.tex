...
For example, the ``chunking'' method developed in \citep{Vapnik82estimation,Perezcruz04double}, the decomposition methods developed in \citep{Osuna97an,Joachims98making}, {Sequential Minimum Optimization} (\smo) developed in \citep{Platt98sequential,Platt99fast}, the ``digesting'' method developed in \citep{Decoste02support}.
