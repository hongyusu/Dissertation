...
The research questions can be casted as following:
\begin{itemize}
...
For the general multilabel classification problem without pre-established output graph, we develope several new algorithms that can combine a set of structured output learners built on a set of random output graphs.
...
Thus, the proposed methods widen the applicability of structured output learning.
