...
Limiting the applicability of these methods is the fact that they are mostly developed from the ensemble approaches for single task problem, and are specially tailored for the application for which it is not immediately clear how to apply to other machine learning tasks.
