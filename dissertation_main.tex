...
$h(\phib(\vx))$ is a linear feature mapping function defined as
\begin{align*}
	h(\vx)[i] = \ip{\vu_i}{\phib(\vx)},
\end{align*}
where $\phib(\vx)\in\RR^d$ is in the original feature space and $\vu_i\in\RR^{d}$ is a linear feature map.
