...
Empirical risk minimization is ill-posed which in principle can provide infinity number of estimators with the same empirical risk on the same training data.
