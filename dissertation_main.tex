...
Besides, other regularization functions are also studies, to name a few, $L_{1,2}$ norm \citep{Argyriou07multitask} and elastic net regularization \citep{Zou05regularizationa}.
