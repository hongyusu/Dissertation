...
Both methods and the empirical results have demonstrated that structured output learning is an important extension to flat multilabel classification approach for predicting multiple interdependent output variables.
