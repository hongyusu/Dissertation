...
We start our discussion in Section~\ref{sc_su10} by presenting a new approach for multilabel molecular classification problem.
...
In Section~\ref{sc_su11}, we present a majority voting ensemble (\mve) that combines a set of structured output classifiers learnt with different random output graphs.
