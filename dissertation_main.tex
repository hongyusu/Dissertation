...
However, this cannot be taken as granted as it is difficult to obtain the correct dependency structure for the output variables in many applications \citep{Chickering94learning}.
