...
Machine learning, defined by Arthur Samuel as ``a field of study that gives computers the ability to learn without being explicitly programmed'', has become an active research field in information and computer science during the past few decades.
...
Besides, we study the proposed models from the theoretic aspect where we wish to gain better understanding of the behaviour.
