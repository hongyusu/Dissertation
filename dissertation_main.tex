...
Multilabel classification is a natural extension to single-label classification by defining multiple valued output associated with each input instant.
...
The flat multilabel classification problem has draw increasing amount of interest from machine learning community \citep{Tsoumakas07multi,Tsoumakas10mining}, and been tackled by many algorithms that aim to exploring the correlation and dependency between multiple output variables in order to make better prediction \citep{Read09classifier,Cheng09combining,Bian12corrlog}.
