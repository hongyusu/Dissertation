...
Current structured output learning approach builds an output graph connecting multiple output variables to model the label dependency in a comprehensive manner.
...
The second outcome of the thesis is to developed new learning algorithms for structured output learning when the output graph is hidden.
...
The joint learning and inference in \rta\ ensures the set of random spanning trees are optimized simultaneously towards the same global objective.
