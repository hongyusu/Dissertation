...
\mlknn\ is derived from $K$-Nearest Neightbor (\knn) algorithm which is an instant based learning originally designed for single-label classification problem.
