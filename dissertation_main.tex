...
%
%
\section{Regularized Risk Minimization}\label{sc_emp}
...
\end{align*}
In practice, the Perceptron algorithm uses stochastic gradient descent that iteratively processes from training data one example at a time.
...
\begin{align*}
	\vw \leftarrow \vw + \rho y_i \vx_i, \, b \leftarrow b + \rho y_i,
\end{align*}
...
\end{align}
using the weight vectors and the corresponding weights output from the algorithm.
