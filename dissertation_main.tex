...
We can also design the optimization techniques for $L_1$-norm regularization as the current alternative optimization strategy proposed by \citet{Rakotomamonjy08simplemkl} is not efficient.
The theoretical properties can also be extended from \rta\ to the new model. 
