...
%
%------------------------------------------------
\chapter{Ensemble Methods} \chapter{ch_em}
...
\subsection{Ensemble Methods for Multi-Label Classification} \label{sc_emmlc}
...
Multi-label classification is a nature extension to the single-label classification presented in Chapter~\ref{ch_slc}.
