...
in speech recognition applications \citep{Fiscus97a,Benesty08speech,Petrov10products}.
Limiting the applicability of these methods is the fact that they are mostly tailored for the application and it is not immediately clear how to apply to other machine learning tasks.
In addition, \citet{Kocev13tree} have developed ensemble approaches based on bagging with the limitation that the methods can only use decision tree as the base learner.
