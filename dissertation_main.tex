...
In particular, if $\Xcal$ is already a dot product space, we can define a linear feature map $\varphib_{\text{\sc linear}}:\Xcal\rightarrow\Xcal$, which corresponds to the simplest \textit{linear kernel}
\begin{align*}
