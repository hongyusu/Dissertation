...
We should also design the optimization techniques for $L_1$-norm regularization as the current alternative optimization approach proposed by \citet{Rakotomamonjy08simplemkl} is not efficient.
