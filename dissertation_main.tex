...
In many cases, no other information about $f^t(x)$ is available to $H(x)$ except that each weak hypothesis will take in a parameter $\vx$ and output $y\in\Ycal$ in single-label classification setting, or $\vy\in\vYcal$ in multilabel classification setting respectively.
