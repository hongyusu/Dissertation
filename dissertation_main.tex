...
The structured output learning approaches rely on the representation of multiple output variables through an output graph which allows us to exploit the correlation between labels.
