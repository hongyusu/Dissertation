...
\item How to tackle the problem in structured output learning of which the output structure is unknown?
...
What has been shown in the thesis is a new learning framework with algorithm instantiation for structured output learning where the structure of the output is not known but is expected to play an important role.
