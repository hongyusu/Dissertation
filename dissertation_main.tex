...
\textit{Graph labeling classification} is another type of structured output prediction in which the output graph can have arbitrary form (e.g. Markov network).
Therefore, it does not have a concept ``level'' as in hierarchical classification.
The structured output prediction models often directly incorporate the output dependency structure into the learning process in order to improve the classification performance \citep{lafferty01,taskar02,Taskar04max,THJA04}.
