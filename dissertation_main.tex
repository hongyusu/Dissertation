...
Meanwhile, current structured output learning approaches rely on an output graph connecting multiple output variables to exploit the correlation between labels.
...
In particular, we are interested in the properties of the new algorithms (e.g., the generalization error bound, conditions for exact inference) when we randomly sample spanning trees from a general graph rather than a complete graph.
