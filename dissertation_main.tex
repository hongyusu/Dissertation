...
Nevertheless, \mmmn\ improves \crf\ due to the following two reasons.
First, \mmmn\ does not require partition function to be computed. 
Secondly, complex loss function can be defined for \mmmn\ as long as the function is decomposable.

%
% 
\subsection{Support Vector Machines for Interdependent and Structured Outputs (\svmstruct)}
