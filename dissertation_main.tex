...
After that, we will discuss formalism of \svm\, the primal-dual optimization strategy, and the kernel methods that allow \svm\ to deal with high dimensionality of the input feature space.
