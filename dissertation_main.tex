...
Alternative approaches for flat multilabel classification include but are not limited to, for example, learning with ranking method \citep{Elisseeff01akernel,Brinker07case,Furnkranz08multilabel,Chiang12a}, learning with perceptron or neural network approaches \citep{Crammer03afamily,Zhang06multilabel}, transformation to label powerset \citep{Tsoumakas07random}.
The author realizes that it is impossible to cover every lines of research in the field of flat multilabel classification.
Interested readers are pointed out to the recent research review articles, for example, in \citep{Tsoumakas07multi,Tsoumakas10mining,Zhang14a}
