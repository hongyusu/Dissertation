...
Hierarchical classification is one type of structured output prediction in which the prediction needs to be addressed based on the hierarchical structure on multiple labels.
