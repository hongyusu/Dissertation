...
\begin{align*}
	\Omega_{L_2}(f) = ||\vw||_2=\left(\sum_{i=1}^d|\vw[i]|^2\right)^{\frac{1}{2}}, \label_{l2_norm}
\end{align*} 
...
\end{align}
In fact, (\ref{lr_posteriori_log}) is an instantiation of regularization risk minimization described in (\ref{rl}) with $L_2$-norm regularization (\ref{l2_norm}) and exponential loss function (\ref{exp_loss}).
