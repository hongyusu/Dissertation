...
The author will explain two prominent algorithms in this area: the Logistic Regression and the Support Vector Machines.
...
% some history
The Support Vector Machines (\svm) is probably the most widely used single-label classification algorithm in many real world applications.
...
For algorithm adaptation category, we will describe the methods that directly modify the popular learning techniques (e.g. the Logistic Regression and the ensemble method) to solve the multilabel classification problem.
...
The Support Vector Machine for interdependent and structured output space (\svmstruct) is developed in \citep{THJA04,TJTA05}.
