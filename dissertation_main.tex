...
Meanwhile, the current structured output learning approaches rely on an output graph connecting multiple output variables in order to exploit the correlation between labels.
