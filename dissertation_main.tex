...
The most typical way is known as \textit{binary relevant} (\br) proposed by \citet{Tsoumakas07multi,Tsoumakas10mining}.
...
In this chapter, we extend the structure output learning to the scenario where the output graph is hidden, by exploring the potential of learning from a random set of spanning trees.
...
We examine the performances of both methods.
