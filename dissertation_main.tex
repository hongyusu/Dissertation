...
Definition~\ref{primalrta} is an instantiation of the regularized learning (Section~\ref{rl}) with $L_2$-norm regularization (\ref{l2norm}) and hamming loss (\ref{hamming_loss}).
