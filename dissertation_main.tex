...
Each section is mostly build upon one publication.
The section will start with background knowledge that is necessary to understand the content of the publication, and will followed by the brief discussion about the theoretical end technical novelties.
...
\subsection{Graph Kernels for Small Molecules}
