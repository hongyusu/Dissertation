...
\end{align}
The optimization problem derived from (\ref{crf_inference}) is an instantiation of the regularized risk minimization (\ref{lr}) with the log loss (\ref{log_loss}) and $L_2$-norm regularization.
