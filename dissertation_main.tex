...
\spin\ has beed applied in network influence prediction problem.
...
The current structured output learning approach rely on representing the label correlation as a output graph which is assumed to be observed.
...
Besides, we have studied the behaviour of the proposed methods in terms of reconstruction error of the compatibility score as well as the generalization error which guaranteed the performance of the proposed models.

In addition, we have design the inference algorithms for the proposed structured output learning methods, which can avoid the exponential number of parameter space. 
