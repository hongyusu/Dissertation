...
To measure the goodness of the estimator, we define a loss function (risk function) $\Lcal(\vy,f(\vx)):\Xcal\times\Xcal\rightarrow\RR^+$ between the true value $\vy$ and the predicted value $f(\vx)$.
...
\end{align*}
\textit{Square Error Loss} (e.g., in Ridge Regression by \citet{Hoerl00ridge})
\begin{align*}
