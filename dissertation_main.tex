...
In Section~\ref{sc_su11}, we present \mve\ which uses majority vote to combines the predictions of a set of structured output learners built from a collection of random output graphs.
...
Therefore, in \citepub{su11}, we explore the potential of using majority vote to combine the predictions of a set of structured output learners built on a collection of random output graphs.
