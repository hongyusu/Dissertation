...
Unlike the previous methods which model the influence in terms of the network connectivity, the proposed model (\spin) is \textit{context-sensitive}, namely, the influence dynamics also depends on the properties of the action performed on the network.
