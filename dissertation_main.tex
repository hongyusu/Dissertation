...
It builds a graph structure (e.g. chain, tree) to connect multiple output variables by which it gain advantage of exploring the label correlation compared to flat multilabel classification.
...
We will present our new structured output learning approaches to solve molecular activity prediction problem as well as network influence prediction problem.
