...
In this section, we will briefly present several related algorithms for structured output prediction include the Structured Perceptron, the Conditional Random Field, the Structured \svm, and the Max-Margin Markov Network.
