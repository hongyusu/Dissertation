...
There is another line of research on multilabel classification known as \textit{structured output prediction} where we define a complex structure (output graph) over multiple output variables to model the dependency in a more comprehensive way.
