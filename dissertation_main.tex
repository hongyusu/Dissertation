...
For algorithm adaptation category, we will describe the method that directly modify the popular learning techniques (e.g. \lr\ and ensemble method) to solve the multilabel classification problem.
Nevertheless, the present algorithms will explore the inherited difficulties of flat multilabel classification, namely the exponential multilabel space and the implicit label correlation.
...
We will present our new structured output learning approaches to solve the molecular activity prediction problem as well as the network influence prediction problem.
...
In this section, we will briefly present several related algorithms for structured output learning include structured Perceptron, Conditional Random Field, structured \svm, and Max-Margin Markov Network.
