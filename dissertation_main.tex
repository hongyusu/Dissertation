...
\item How to apply structured output learning on the multilabel classification problem when the dependency structure is not observed.

\item Can we understand the behavior of the proposed structured output learning models from theoretical aspect? 
