...
\textit{Hierarchical classification} is one type of structured output prediction in which the prediction needs to be propagated along the pre-established hierarchical structure defined on multiple labels \citep{Silla11a}.
