...
Popular loss functions used in machine learning include \textit{Hamming Loss} (e.g. \svmstruct\ in Section~\ref{sc_svmsruct})
\begin{align*}
...
\end{align*}
\textit{Exponential Loss} (e.g. \adaboost\ in Section~\ref{sc_adaboost})
\begin{align*}
