...
The approach can be applied to wider range of problems, for example, using sequence structure in speech tagging problem \citep{collins02a}, using Markov network structure in action recognition problem \citep{Wang11hidden}. 
...
\begin{figure}
	...
	\caption{Taxonomy structure of multilabel classification.}
