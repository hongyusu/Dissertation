...
The empirical risk minimization strategy is ill-posed which in general can provide infinity number of estimators with same empirical risk on the training data.
...
In other words, underlying true distribution $P(\vx,\vy)$ is difficult to be estimated from a finite sample of training examples.
