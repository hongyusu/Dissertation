...
The first is scalability in which a set of single-label classifiers need to be built independently in order to predict multiple activities which soon becomes infeasible when large amount of activities need to be predicted.
