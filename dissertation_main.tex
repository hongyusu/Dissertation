...
In particular, some hierarchical classification algorithms can also belong to graph labeling category, for example the one developed in \citep{THJA04,Rousu06}.
...
We also investigate the efficiency and the scalability of the inference problems in the proposed structured output learning models as they are often difficult to solve.
