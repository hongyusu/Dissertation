...
\end{align*}
With the edge compatibility scores, we can infer the \textit{max-marginal} \citep{Wainwright05map} of the $i$'th node which is the score incurred by assigning a label $u_i\in\Ycal_i$ to the $i$'th node defined by
\begin{align*}
