...
Besides, \citepub[Theorem 5]{su14c} shows the good generalization error can also be guaranteed when learning with in stead of complete graph a sample of spanning trees.
