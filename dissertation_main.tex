...
\rta\ also lays the foundation of performing graph inference on unknown graph structure in which fast optimization and accurate prediction can be guaranteed with attainable computational efforts.
