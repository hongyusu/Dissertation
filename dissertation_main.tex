...
When the multiple output variables are treated as a ``flat'' vector, the problem is known as flat multilabel classification .
...
In structured multilabel classification problem, multiple interdependent output variables are usually located in a structured output space where the dependency or correlation of the variables is defined by the structure of an output graph (e.g. Markov network).
