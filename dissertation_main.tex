...
\end{align}
The optimization problem derived from (\ref{crf_inference}) is solved in \citep{lafferty01} by the improved iterative scaling algorithm (\iis) \citep{Pietra97inducing}.
