...
Structured output learning with complete graph is not an easier problem as the inference is \nphard\ in nature.
...
Besides, \citepub[Theorem 5]{su14c} shows the good generalization error can also be guaranteed when learning with instead of complete graph a sample of spanning trees.
...
Besides, \citepub[Theorem 5]{su14c} suggests we should, instead of optimizing the margin separatly on each spanning tree similar as in \mam, optimize the joint margin from all spanning trees.
