...
The methods and the empirical results have demonstrated that structured output learning is an important extension to flat multilabel classification approach for predicting multiple interdependent output variables.

The second outcome of the thesis is that we have developed new methods for structured output learning when the output dependency structure is not observed.
In particular, the new methods aim to learn from a random set of spanning trees that connect multiple output variables.
