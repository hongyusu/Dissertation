...
We focus on the efficiency and the scalability of the proposed structured output prediction models, as the inference problem is ofter \nphard\ to solve.
Additionally, the new learning models are well motivated.
The theoretical study is able to explain the behaviour and to guarantees the performance of the models.
...
Section~\ref{sc_su11} and Section~\ref{sc_su14a} discuss three ensemble model (\mve, \amm, \mam) that tackle the problem in structured output prediction when the output structure is unknown.
...
Finally, Chapter~\ref{ch_conclusion} concludes the thesis by answering the research questions and by pointing out possible future directions.
