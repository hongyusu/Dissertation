...
In \citepub{su14b}, we aimed to develop advanced aggregation techniques (\amm\ and \mam\ respectively) that also perform inference before or after forming ensemble.
...
In \citepub{su14a}, we developed a structure output learning model for network response prediction problem.
The proposed model, \spin, is \textit{context-sensitive} and is different from the previous the state-of-the-art models which only model the influence in terms of the connectivity.
