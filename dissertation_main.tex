...
In addition, we have explored the inference algorithms for the proposed structured output learning methods, which can avoid the exponential number of parameter space and provide fast convergence.
