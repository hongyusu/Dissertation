...
\end{align*}
where $\phib_e(\vx,\vy_e)=\varphib(\vx)\otimes\Upsilonb_e(\vy_e)$ is the tensor product of an input feature and an output feature of a multilabel $\vy$ on an edge $e\in E$ in an output Markov network $G$.
