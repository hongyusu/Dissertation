...
For example, ``chunking'' methods developed in \citep{Vapnik82estimation,Perezcruz04double}, decomposition methods developed in \citep{Osuna97an,Joachims98making}, {Sequential Minimum Optimization} (\smo) developed in \citep{Platt98sequential,Platt99fast}, ``digesting'' methods developed in \citep{Decoste02support}.
