...
For the general multilabel classification problem without pre-established output graph, we develope several new algorithms that combine a set of structured output learners built on random output graphs.
