...
What has been shown in the thesis is a new learning approach of structured output learning for multilabel classification where the output dependency structure of the multiple output variables is not observed but is assumed to be critical.
An immediate extension is to explore its various potentials in real world multilabel classification applications where the the dependency structure is difficult to obtain.
