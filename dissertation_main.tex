...
This section will devote to bagging and boosting since both methods are extensively studied and are most related to this thesis.
...
Moreover, we will develop several new learning algorithms in the later part of the thesis, which are related to the ensemble methods presented in this section but with significant difference.
...
To see this, imagine the edges that are not from the correct output graph will have zero ``parameters'' in the complete graph.
