...
The current structured output learning approach rely on representing the label correlation as a output graph.
The output graph is assumed to be observed.
...
The new methods aim to learn from a random set of spanning trees that connect multiple output variables.
